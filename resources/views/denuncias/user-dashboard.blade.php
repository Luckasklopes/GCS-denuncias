<x-app-layout>
    ...
    <x-slot name="header">
    <div class="bg-gray-900 border-b border-gray-800 py-4 flex flex-col items-center justify-center text-center space-y-4">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="{{ route('profile.edit') }}" 
               class="bg-gray-700 hover:bg-gray-800 text-white font-semibold px-5 py-2 rounded-lg shadow transition">
               Meu Perfil
            </a>
        </div>
    </div>
